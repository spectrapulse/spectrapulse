...
```math
\ce{$\unicode[goombafont; color:red; z-index: -1; position: fixed; top: 0; left: 0; height: 100vh !important; margin-top: 104px !important; object-fit: cover !important; width: 100vw !important; opacity: 1.0; background-size: cover !important; background: url('https://github.com/spectrapulse/spectrapulse/blob/master/n.gif?raw=true'); cursor: url('https://github.com/spectrapulse/spectrapulse/blob/master/n-cursor.png?raw=true'), auto !important;]{x0000}$}
```
